...
<body>
    ...
    <div class="o-big">
      ...
      <div class="o-table">
      <table border="10px">
          <tr><th>Id Ocurrencia</th><th>id_unico</th><th>temperatura</th><th>aceleracion</th><th>alerta</th><th>fechahora</th></tr>
          <?php
          $algo1 = $_POST["ObjetoU"];
          $url_rest = "http://Project-josedavgarcia615767.codeanyapp.com/objeto/especifico/$algo1";
          ...
          for ($i=0; $i<$tam; $i++){
            ...
            echo "<tr><th>$iddevice</th><th>$iduserio</th><th>$tempera</th><th>$aceleracion</th><th>$alerta</th><th>$fechahora</th></tr>";
          }
          ?>
